...
void __attribute__((picinterrupt(("irq(AD),base(8)")))) ADC_ADI_ISR(void)
{
    PIR1bits.ADIF = 0;
...
void __attribute__((picinterrupt(("irq(ACT),base(8)")))) ADC_ACTI_ISR(void)
{
    PIR1bits.ACTIF = 0;
...
void __attribute__((picinterrupt(("irq(ADCH1),base(8)")))) ADC_ADCH1_ISR(void)
{
    PIR2bits.ADCH1IF = 0;
