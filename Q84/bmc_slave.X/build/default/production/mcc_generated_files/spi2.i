...
# 57 "mcc_generated_files/spi2.h" 2
...
# 49 "mcc_generated_files/spi2.c" 2
...
void __attribute__((picinterrupt(("irq(SPI2),base(8)")))) SPI2_Isr(void)
{
...
void __attribute__((picinterrupt(("irq(SPI2RX),base(8)")))) SPI2_RxIsr(void)
{
