...
void __attribute__((picinterrupt(("irq(PWM2),base(8)")))) PWM2_16BIT_PWMI_ISR()
{
    PIR5bits.PWM2IF = 0;
...
void __attribute__((picinterrupt(("irq(PWM2PR),base(8)")))) PWM2_16BIT_PWMPI_ISR()
{
    PIR5bits.PWM2PIF = 0;
