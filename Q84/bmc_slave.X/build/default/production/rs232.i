...
void update_rs232_line_status(void)
{
 ...
 V.tx_volts = (adc_scale_zero + (int16_t) V.v_tx_line) / neg_scale;
 if (V.tx_volts > 0) {
  V.tx_volts = (adc_scale_zero + (int16_t) V.v_tx_line) / pos_scale;
 } else {
  if (V.tx_volts < line_zero_limit) {
   V.tx_volts = 0;
  }
 }
...
static char line_status(const adc_result_t value)
{
 ...
 if ((value < (2048 - 50)) && (value > (1920 - 50))) {
  status_c = 'O';
 }

 if ((value > (2048 + 100)) && (value < (2390 + 500))) {
  status_c = 'S';
 }

 if ((value < (2048 - 300)) && (value > (1425 - 500))) {
  status_c = 'M';
 }
