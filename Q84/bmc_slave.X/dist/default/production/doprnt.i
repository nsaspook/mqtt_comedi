...
# 872 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
...
# 1432 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
   ...
   *fmt = cp+1;
   switch (*cp) {
    ...
    case 'o':
# 1519 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
...
# 1798 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
        if ((*fmt)[0] == '%') {
            ++*fmt;
            fputc((int)'%', fp);
            return (int) 1;
