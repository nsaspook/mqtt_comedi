...
static int dtoa(FILE *fp, vfpf_sint_t d)
{
 ...
 int p;
    ...
    s = d < 0 ? 1 : 0;
# 533 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
    p = (0 <= prec) ? prec : 1;
...
# 552 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
    i = sizeof(dbuf) - 1;
    dbuf[i] = '\0';
    while (!(i < 1) && (d != 0
...
static int utoa(FILE *fp, vfpf_uint_t d)
{
 ...
 int p;
# 1017 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
    p = (0 <= prec) ? prec : 1;
...

{
 ...
 int p;
# 1080 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
    p = (0 <= prec) ? prec : 1;

    w = width;
# 1091 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
 a = x == 'x' ? 'a' : 'A';
...
# 1152 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
    return (int) pad(fp, &dbuf[i], w);
}
...
# 1201 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
    if ((*fmt)[0] == '%') {
        ...
        flags = width = 0;
        prec = -1;
# 1256 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
...
# 1284 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
  ...
  c = *cp;
  switch(c) {
# 1308 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
   case 'l':
    cp++;
    ...
    break;
# 1335 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
   case 'u':
  ...
  if (*cp == 'd' || *cp == 'i') {
   ...
   switch (c) {
    case 'i':
     ...
     break;
# 1378 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
    case 'l':
     convarg.sint = (vfpf_sint_t)(*(long *)__va_arg(*(long **)ap, (long)0));
     break;
# 1402 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
   }



   *fmt = cp+1;
# 1432 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
  ...
  if (0
   ...
   switch (c) {
    case 'i':
     ...
     break;
# 1469 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
    case 'l':
     convarg.uint = (vfpf_uint_t)(*(unsigned long *)__va_arg(*(unsigned long **)ap, (unsigned long)0));
     break;
# 1493 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
   }
   ...
   *fmt = cp+1;
   switch (*cp) {
# 1523 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
    case 'u':
# 1542 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
    ...
    case 'x':
# 1586 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
     return (int) xtoa(fp,convarg.uint,*cp);


   }
  }
# 1656 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
  done = 0;
  if ((*fmt)[0] == 's') {
   ++*fmt;
   done = 1;
  ...
  if (done) {
# 1682 "/opt/microchip/xc8/v3.00/pic/sources/c99/common/doprnt.c"
